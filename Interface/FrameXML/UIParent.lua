...
COLLECTIONS_JOURNAL_TAB_INDEX_NEWS = 1;
COLLECTIONS_JOURNAL_TAB_INDEX_MOUNTS = COLLECTIONS_JOURNAL_TAB_INDEX_NEWS + 1;
COLLECTIONS_JOURNAL_TAB_INDEX_AURAS = COLLECTIONS_JOURNAL_TAB_INDEX_MOUNTS + 1;
COLLECTIONS_JOURNAL_TAB_INDEX_PETS = COLLECTIONS_JOURNAL_TAB_INDEX_AURAS + 1;
