...
LE_AURAS_JOURNAL_FILTER_COLLECTED = 1;
LE_AURAS_JOURNAL_FILTER_NOT_COLLECTED = 2;
NUM_LE_AURAS_JOURNAL_FILTERS = 2;
...
-- WCollections: custom indexing only for things we (potentially) care about to keep the overall number below 32 to allow it to fit into a numeric bitfield
...
LE_FRAME_TUTORIAL_WCOLLECTIONS_MICRO_BUTTON = 14;
LE_FRAME_TUTORIAL_WCOLLECTIONS_PORTRAIT_BUTTON = 15;
LE_FRAME_TUTORIAL_WCOLLECTIONS_TRANSMOG_TAB = 16;
...
WARDROBE_TOOLTIP_CYCLE_ARROW_ICON = [[|TInterface\AddOns\WCollections\Interface\Transmogrify\transmog-tooltip-arrow:12:11:-1:-1|t]];
WARDROBE_TOOLTIP_CYCLE_SPACER_ICON = [[|TInterface\AddOns\WCollections\Interface\Common\spacer:12:11:-1:-1|t]];
