WCollections.CFBG = WCollections.CFBG or { };

hooksecurefunc("MiniMapBattlefieldFrame_isArena", function()
    if WCollections.CFBG.Faction and WCollections.Config.Misc.CFBGFactionIcons and UnitInBattleground("player") and UnitFactionGroup("player") and MiniMapBattlefieldIcon:GetTexture() == [[Interface\BattlefieldFrame\Battleground-]]..UnitFactionGroup("player") then
        MiniMapBattlefieldIcon:SetTexture([[Interface\BattlefieldFrame\Battleground-]]..WCollections.CFBG.Faction);
    end
end);

hooksecurefunc("PlayerFrame_UpdatePvPStatus", function()
    if WCollections.CFBG.Faction and WCollections.Config.Misc.CFBGFactionIcons and UnitInBattleground("player") and UnitIsPVP("player") and UnitFactionGroup("player") and PlayerPVPIcon:GetTexture() == [[Interface\TargetingFrame\UI-PVP-]]..UnitFactionGroup("player") then
        PlayerPVPIcon:SetTexture([[Interface\TargetingFrame\UI-PVP-]]..WCollections.CFBG.Faction);
        PlayerPVPIconHitArea.tooltipTitle = _G["FACTION_"..strupper(WCollections.CFBG.Faction)];
        PlayerPVPIconHitArea.tooltipText = _G["NEWBIE_TOOLTIP_"..strupper(WCollections.CFBG.Faction)];
    end
end);
...
local function GuessFlagPositions()
    ...
    if WCollections.CFBG.Faction and WCollections.Config.Misc.CFBGFactionIcons and UnitInBattleground("player") then
...
function GetBattlefieldFlagPosition(i)
    ...
    if WCollections.CFBG.Faction and WCollections.Config.Misc.CFBGFactionIcons and UnitInBattleground("player") then
        ...
        local myFaction = WCollections.CFBG.Faction or "";
