...
local function Hook()
    ...
    local function GetShortageRewardInfo(dungeonID, i)
        ...
        if link then
            local id = WCollections.GetItemID(link);
            if id then
    ...
    local function InjectRoleButton(button)
        ...
        button.shortageBorder:SetTexture([[Interface\AddOns\WCollections\Interface\Common\GoldRing]]);
        ...
        button.incentiveIcon.border:SetTexture([[Interface\AddOns\WCollections\Interface\LFGFrame\UI-LFG-ICON-REWARDRING]]);
    ...
    local function InjectRewardButton(button)
        ...
        button.shortageBorder:SetTexture([[Interface\AddOns\WCollections\Interface\TalentFrame\TalentFrame-Parts]]);
...
function WCollections:AddCTAShortageReward(item, ctaReward)
...
function WCollections:ResetCTAShortageReward()
